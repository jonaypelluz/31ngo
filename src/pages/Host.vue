    ...
    <div class="form-wrapper text-center">
      ...
      <div v-if="showActions">
        <div class="game-mode" v-if="!mode">
          ...
          <p class="description">
            ...
            <b>PRIVADO</b> se limita hasta 40 jugadores que tendrán un código de partida privado
            para cada uno de ellos. Una vez que el anfitrión empieza la partida no se podrá acceder
            a ella.
          </p>
      ...
      <base-card v-if="game">
        ...
        <h5>
          ...
          <div v-if="mode === 'private'">
            Los códigos individuales los encontrarás al entrar en la partida en la barra lateral.
          </div>
        </h5>
...
export default {
    ...
    showCreateBtn() {
      return (
        ...
        (this.mode === Constants.BINDO_MODE_PUBLIC ||
          (this.players > 0 && this.players <= Constants.BINDO_MODE_PRIVATE_MAX_PLAYERS))
      );
    },
    showActions() {
      return !this.game;
  ...
  methods: {
    chooseGameMode(mode) {
      if (mode === Constants.BINDO_MODE_PRIVATE || mode === Constants.BINDO_MODE_PUBLIC) {
        this.mode = mode;
      }
    },
    copyHash() {
